            ...
            if use_caching:
                ...
                def apply_function(row):
                    ...
                    try:
                        ...
                        print("Add score: catch error with default")
                        # this is needed to know the structure in case the metric returns a dictionary.
                        dummy_res = function("Dummy.", "This is a dummy sentence.")
                        try:
                            dummy_dict = ast.literal_eval(dummy_res)
                            for key in dummy_dict.keys():
                                dummy_dict[key] = None
                            return str(dummy_dict)
                        except:
                            return dummy_res
            else:
                if print_timing:
